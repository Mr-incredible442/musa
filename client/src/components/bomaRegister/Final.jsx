...
function Final() {
  ...
  const handleDeleteDate = () => {
    apiCall
      .post(`${BOMA_REGISTER_URL}/${RegisterShift._id}/deletedate`)
      .then(() => {
        check();
      });
  };
  const handleDeleteName = () => {
    apiCall
      .post(`${BOMA_REGISTER_URL}/${RegisterShift._id}/deletename`)
      .then(() => {
        check();
      });
  };
  const handleDeleteAccountant = () => {
    apiCall
      .post(`${BOMA_REGISTER_URL}/${RegisterShift._id}/deleteaccountant`)
      .then(() => {
        check();
      });
  };
  ...
  const handleDeleteCash = () => {
    apiCall
      .post(`${BOMA_REGISTER_URL}/${RegisterShift._id}/deletecash`)
      .then(() => {
        check();
      });
  };
  ...
  const handleDeleteChange = () => {
    apiCall
      .post(`${BOMA_REGISTER_URL}/${RegisterShift._id}/deletechange`)
      .then(() => {
        check();
      });
  };
