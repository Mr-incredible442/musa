...
function EditCashMobile({ field, id, fieldIndex, value }) {
  ...
  useEffect(() => { if (show) setAmount(value); }, [show, value]);
  ...
  const handleSubmit = (e) => {
    ...
    setIsLoading(true);
    apiCall
      .post(`${baseUrl}/${id}/updatecashmobile`, { field: fieldIdentifier, amount })
    ...
    <>
      ...
      <Modal show={show} onHide={handleClose} backdrop="static" centered keyboard={false}>
        <Modal.Header closeButton>
          <Modal.Title>Edit {field} Cash Mobile</Modal.Title>
        </Modal.Header>
        <Modal.Body>
