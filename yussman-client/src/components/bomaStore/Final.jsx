...
function Final() {
  ...
  const handleDeleteDate = () => {
    apiCall.post(`${BOMA_STORE_URL}/${storeShift._id}/deletedate`).then(() => {
      check();
    });
  };
  ...
  const handleDeleteAccountant = () => {
    apiCall
      .post(`${BOMA_STORE_URL}/${storeShift._id}/deleteaccountant`)
      .then(() => {
        check();
      });
  };
  ...
  const handleDeleteKeeper = () => {
    apiCall
      .post(`${BOMA_STORE_URL}/${storeShift._id}/deletekeeper`)
      .then(() => {
        check();
      });
  };
  ...
  const handleDeleteCheckedBy = () => {
    apiCall
      .post(`${BOMA_STORE_URL}/${storeShift._id}/deletecheckedby`)
      .then(() => {
        check();
      });
  };
