...
import { LusakaShopContext } from '../../context/LusakaShopContext';
...
function Final() {
  ...
  const { shift } = useContext(LusakaShopContext);
  ...
  const handleDeleteCashier = (name) => {
    apiCall
      .post(`${LUSAKA_SHOP_URL}/${shift._id}/removecashier`, {
  ...
  const handleDeleteAcountant = () => {
    apiCall
      .post(`${LUSAKA_SHOP_URL}/${shift._id}/removeaccountant`)
      .then(() => {
        check();
      });
  };
  const handleDeleteShift = () => {
    apiCall.post(`${LUSAKA_SHOP_URL}/${shift._id}/deleteshift`).then(() => {
      check();
    });
  };
  const handleDeleteDate = () => {
    apiCall.post(`${LUSAKA_SHOP_URL}/${shift._id}/deletedate`).then(() => {
      check();
    });
  };
